                            ...
                            <table width="100%" border="1" cellspacing="0" cellpadding="10">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <p> PI 200-3 <a
                                                    href="https://www.renishaw.com/cmmsupport/knowledgebase/en/connector-pin-outs--15472"
                    ...
                    <div class="tab-pane fade" id="tab2" role="tabpanel">
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <a href="{{ asset('assets/ppt/PH10_PLUS_presentation.pptx') }}"
                                    ...
                                    <img style="width: 100px; height: 100px;"
                                        src="{{ asset('assets/thumbnails/pptx_icon.png') }}" alt="pdf">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <a href="{{ asset('assets/docs/PFC10-3/H-1000-0077_(PHC10-3_PLUS_IG).pdf') }}"
                                    class="tab-iiner-cust-link" download>
                                    <img src="{{ asset('assets/thumbnails/PHC10-3-switch-settings.jpg') }}"
                                        alt="pdf">
