        ...
        <div class="container my-5">
            <div class="row">
                <div class="market-content">
                    ...
                    <p>
                        Our reconditioned CMMs come equipped with the latest VDMIS-R2025 Metrology software, brand-new PCs with Windows 11, and
                        ...
                        <div class="row card flex-row shadow my-3">
                            <div class="col-lg-6 col-md-12 p-3">
                                <div class="used-cmm-image">
                                    <img src="{{ asset('assets/images/' . $data['image']) }}" alt="{{ $data['title'] }}" class="img-fluid">
                                    <h6 class="text-center pt-2 fw-bold text-danger">{{ $data['image_title'] }}</h6>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12 p-3 cmm-card-details">
                                <h3 class="used-cmm-header text-center mb-3">{{ $data['title'] }}</h3>
                                <div class="used-cmm-content">
                                    <p><strong>Stock#:</strong> {{ $data['stock'] }}</p>
                                    <p><strong>Measuring Range:</strong>{{ $data['measuring_range'] }}<span class="theme-color ms-1">{{ $data['measuring_range_mm'] }}</span>
                                    </p>
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <ul>
                                            <li>Intel Duo core I5 processor</li>
                                            <li>16 GB SDRAM</li>
                                            <li>1 TB SSD Hard Drive</li>
                                            <li>4 GB PCI-E NVIDIA Graphic card</li>
                                            <li>Microsoft Windows 11 Pro, 64 bit</li>
                                            <li>27” High Definition 1080P Flat Panel</li>
                                            <li>Color Monitor</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="used-cmm-request text-center">
                                    <a href="{{ route('request.quote') }}">
                                        <img src="{{ asset('assets/images/request.png') }}" alt="Used CMM Logo" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                        </div>
